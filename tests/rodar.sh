...
preparar() {
  ...
  carregar "$RAIZ/supabase/19_teto_online.sql"
  ...
  carregar "$RAIZ/supabase/24_produtos.sql"
  carregar "$RAIZ/supabase/25_loja.sql"
  carregar "$RAIZ/supabase/26_estoque.sql"
